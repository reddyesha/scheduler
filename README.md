...
## Background
This simple app makes a call to a scheduler API to retrieve event data. It then display the events in a logical, readable manner. It shows:
* events happening in the next 24 hours
* events that have happened in the previous 3 hours from the current time
* all upcoming events beyond the next 24 hours
* all past event beyond the last three hours
